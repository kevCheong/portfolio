          ...
          <div className="nine columns main-col">
            <div className="row item">
              <div className="twelve columns">
                ...
                <p className="info">{data.major} <span>•</span> <em className="date">Graduated December 2018</em></p>
                <p>
                {data.uniDescription}
                </p>
              </div>
            ...
            <div className="row item">
              <div className="twelve columns">
                <h3>{data.highSchool}</h3>
                <p className="info">{data.schoolDegree} <span>•</span> <em className="date">March 2003</em></p>
                <p>
